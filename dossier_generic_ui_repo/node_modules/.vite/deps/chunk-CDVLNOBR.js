...
var useJsonFormsCategorization = function useJsonFormsCategorization2(props) {
  var _useJsonFormsLayout = useJsonFormsLayout(props), layout = _useJsonFormsLayout.layout, other = _objectWithoutProperties(_useJsonFormsLayout, _excluded10);
...
var script = defineComponent({
  ...
  data: function data() {
    ...
    var uischemaToUse = (_this$uischema = this.uischema) !== null && _this$uischema !== void 0 ? _this$uischema : Generate.uiSchema(schemaToUse, void 0, void 0, schemaToUse);
    var initCore = function initCore2() {
      ...
      var core = _this.middleware(initialCore, index$1.init(dataToUse, schemaToUse, uischemaToUse, {
    ...
    return {
      ...
      jsonforms: {
        core: initCore(),
        config: configReducer(void 0, index$1.setConfig(this.config)),
        i18n: i18nReducer(this.i18n, index$1.updateI18n((_this$i18n = this.i18n) === null || _this$i18n === void 0 ? void 0 : _this$i18n.locale, (_this$i18n2 = this.i18n) === null || _this$i18n2 === void 0 ? void 0 : _this$i18n2.translate, (_this$i18n3 = this.i18n) === null || _this$i18n3 === void 0 ? void 0 : _this$i18n3.translateError)),
  ...
  watch: {
    schema: function schema(newSchema) {
      ...
      if (!this.uischema) {
        this.uischemaToUse = Generate.uiSchema(this.schemaToUse, void 0, void 0, this.schemaToUse);
      }
    },
    uischema: function uischema(newUischema) {
      this.uischemaToUse = newUischema !== null && newUischema !== void 0 ? newUischema : Generate.uiSchema(this.schemaToUse, void 0, void 0, this.schemaToUse);
    },
    data: function data2(newData) {
    ...
    config: {
      handler: function handler(newConfig) {
        this.jsonforms.config = configReducer(void 0, index$1.setConfig(newConfig));
      },
      deep: true
    },
    ...
    coreDataToUpdate: function coreDataToUpdate2() {
      this.jsonforms.core = this.middleware(this.jsonforms.core, index$1.updateCore(this.dataToUse, this.schemaToUse, this.uischemaToUse, {
        validationMode: this.validationMode,
        ajv: this.ajv,
        additionalErrors: this.additionalErrors
      }), coreReducer);
    },
    eventToEmit: function eventToEmit2(newEvent) {
      this.$emit("change", newEvent);
    },
    i18n: {
      handler: function handler2(newI18n) {
        this.jsonforms.i18n = i18nReducer(this.jsonforms.i18n, index$1.updateI18n(newI18n === null || newI18n === void 0 ? void 0 : newI18n.locale, newI18n === null || newI18n === void 0 ? void 0 : newI18n.translate, newI18n === null || newI18n === void 0 ? void 0 : newI18n.translateError));
      },
      deep: true
    }
  },
...
//# sourceMappingURL=chunk-CDVLNOBR.js.map
